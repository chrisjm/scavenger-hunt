...
- Never delete a test because it's failing. Instead, raise the issue with Chris.
- Tests MUST comprehensively cover ALL functionality.
- YOU MUST NEVER write tests that "test" mocked behavior. If you notice tests that test mocked behavior instead of real logic, you MUST stop and warn Chris about them.
...
- You MUST NEVER discard tasks from your TodoWrite todo list without Chris's explicit approval
