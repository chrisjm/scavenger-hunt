...
<article
	class="group border-2 rounded-xl p-5 transition-all duration-300 hover:shadow-md focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-green-500 focus-within:ring-offset-transparent {submission.valid
