...
<div class="flex items-center gap-3">
	<div class="flex flex-col">
		<label for="group-selector" class="text-xs font-semibold text-gray-600 dark:text-slate-300">
			Active group
		</label>
		<select
			id="group-selector"
			class="min-w-[180px] rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm shadow-sm focus:border-blue-400 focus:outline-none dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
