	...
	<div class="mb-4 md:mb-6">
		...
		<div class="md:hidden">
			<div class="flex items-center gap-2 mb-3">
				...
				<h2 class="text-lg font-semibold text-gray-800">Community</h2>
			</div>
			<div class="flex bg-gray-100 rounded-lg p-0.5 w-full">
				<button
		...
		<div class="hidden md:flex items-center gap-3">
			...
			<h2 class="text-2xl font-semibold text-gray-800">Community Activity</h2>

			<div class="ml-auto flex bg-gray-100 rounded-lg p-1">
				<button
					onclick={() => (activeTab = 'feed')}
			...
			<div class="transition-all duration-300">
				{#if submissions.length === 0}
					<div class="text-center py-8 md:py-12">
						...
						>
							<span class="text-gray-400 text-xl md:text-2xl">📸</span>
						</div>
						<p class="text-gray-500 text-base md:text-lg font-medium mb-1 md:mb-2">
							No submissions yet
						</p>
